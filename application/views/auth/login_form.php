...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Login Admin Himaprodi</title>
		...
		<!-- Styles -->
		<link href="<?php echo base_url(); ?>asset/admin/css/bootstrap-responsive.css" rel="stylesheet">
		<link href="<?php echo base_url(); ?>asset/admin/css/bootstrap.css" rel="stylesheet">
		<link href="<?php echo base_url(); ?>asset/admin/css/bootstrap-custom.css" rel="stylesheet">
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container"> 
				...
				<a class="brand " href="#">Admin Himaprodi</a>
...
?>
	...
	<div class="container">
		<div class="row">
			...
			<div class="span6" id="form-login">
				<form class="form-horizontal well" method="POST" action="<?php echo base_url(); ?>index.php/auth/login">
					<fieldset> 
	...
	<hr />
		<div class="span12">
			<footer>
			<p>&copy; Admin Himaprodi Informatika 2016.</p>
			</footer>
		</div>
