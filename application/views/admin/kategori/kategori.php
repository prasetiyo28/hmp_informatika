					...
					<div class="span9">
						<div class=""><!-- basic tabs menu -->
							<ul class="nav nav-tabs">
								...
								<li  class="active"><a href="<?php echo base_url(); ?>administrator/kategori_produk/">Kategori Post</a></li>
							</ul>
						</div><!-- basic tabs menu -->
						<h5>Tambahkan Lagi Kategori Post</h5>
